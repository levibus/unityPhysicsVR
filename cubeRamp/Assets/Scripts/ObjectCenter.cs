...
public class ObjectCenter : MonoBehaviour
{
    ...
    void MoveArrows()
    {
        ...
        accArrowObject.transform.eulerAngles = new Vector3((180.0f - normalizedAccAngle), 0.0f, 0.0f);
        ...
        if (transform.position == startPos.getPosition()) {
            ...
            velArrowObject.transform.localScale = new Vector3(1f, /*normalizedSpeed*/ 4f, 1f) * scaleDown;          // using a scaling factor of 4
        ...
        if (currentVel.magnitude <= minSize && transform.position != startPos.getPosition())
        {
            ...
            velArrowObject.SetActive(true);
            velArrowObject.transform.localScale = new Vector3(1f, /*lengthScaling * rb.velocity.magnitude*/ 4f, 1f) * scaleDown;
        }
        ...
        else
        {
            ...
            accArrowObject.transform.localScale = new Vector3(1f, /*lengthScaling * currentAcc.magnitude*/ 4f, 1f) * scaleDown;
        }
